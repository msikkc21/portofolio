...
const PortfolioCard = (props) => {
    return(
        <div className=" bg-slate-300 dark:bg-[#002D5E] py-3 px-3 rounded-xl group">
            <div className="relative border-4 border-slate-500 rounded-xl overflow-hidden">
                ...
                <div className='absolute flex bottom-[-50px] z-10 group-hover:bottom-5 w-[90%] left-[5%] bg-slate-600 dark:bg-[#002D5E] rounded-lg transition-all duration-300 justify-between'>
