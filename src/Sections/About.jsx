  ...
  return (
    <section id="about" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        <div
          ref={headingRef}
          className={`text-center mb-16 scroll-animate ${headingVisible ? 'is-visible' : ''}`}
        >
        ...
        <div
          ref={cardRef}
          className={`bg-white dark:bg-[#001A3A] rounded-2xl shadow-lg p-8 mb-12 transition-all duration-700 hover:shadow-xl scroll-animate ${cardVisible ? 'is-visible' : ''}`}
        ...
        <div
          ref={featuresRef}
          className={`grid md:grid-cols-3 gap-8 scroll-animate ${featuresVisible ? 'is-visible' : ''}`}
        >
