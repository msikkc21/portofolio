...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex items-center max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      {/* Blue background container wrapping content only */}
      <div className="bg-gradient-to-r from-[#0062CC]/10 to-[#007BFF]/10 dark:from-[#001E43]/40 dark:to-[#003366]/40 backdrop-blur-sm rounded-3xl p-6 sm:p-8 w-full shadow-2xl border border-white/20">
